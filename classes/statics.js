...
// reminder: objects are instances of a class
...
console.log('"Halthier"');
console.log(CandyBar.healthier(cb, cb2));

// console.log(cb);
// console.log(cb2);
// access the static method to see how many candybars were created:
// NOTE: you use the Class name for this.
...
console.log(MathUtilities.PI); // I can use this without ever instatiating an object.
